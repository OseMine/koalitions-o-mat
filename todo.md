...
- [x] **`schwankt`-Band hartkodiert 4–6** (script.js:1963) – sollte relativ zur Wahl-Sperrklausel (`threshold`, `tacticalThreshold()`, script.js:1873) sein. **Erledigt am 2026-08-09**: `schwankt` in `calculateTacticalVoting()` ist jetzt relativ zur Sperrklausel (`0 < v < threshold + 1`, script.js:2110), zusätzlich ausgenommen, wenn der kleine Partner über die Grundmandatsklausel abgesichert ist. → in `archived-todo.md`.
