...
Details siehe [`reports/review-2026-08-11.md`](reports/review-2026-08-11.md) – alle Befunde per Headless-Chromium gegen den realen Build verifiziert. **Alle fünf Befunde (P1 ×3, P2 ×2) wurden am selben Tag behoben und verifiziert** – Umsetzung und Verifikationsergebnisse siehe [`archived-todo.md`](archived-todo.md) (Implementierung vom 2026-08-11). Keine offenen Punkte aus diesem Review.
