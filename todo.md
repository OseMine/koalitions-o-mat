...
- [x] **Ergebnis-Karte zeigt rohe Wahl-ID statt Wahl-Name** – `exportCardData()` (script.js:284) `electionName = activeElectionId`; `getActiveElectionName()` (script.js:3470) stattdessen verwenden.
...
- [x] **`svgBar()` leerer Wrapper** (script.js:302) – entfernt (war unbenutzt).
